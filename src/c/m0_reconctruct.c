...
void m0_reconctruct_V0(struct RUN *run,struct BRANCH *crnt,int f,double dist_p1_cf,double dist_p1_cc,
  ...
  if (PRIMTV==1){
    m0_prim2conc(g_S_prim_rec_L,g_S_cons_rec_L);  // g_S_prim_rec_L to g_S_cons_rec_L
    for(iv=0;iv<NEQ;++iv){        
